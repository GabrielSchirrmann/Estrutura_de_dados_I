/*
 * Aula 06 - Grafos
 * 2. Grafo NAO PONDERADO, NAO DIRECIONAL - Lista de Adjacencias
 */
#include <stdio.h>
#include <stdlib.h>
...
static void inserirNaLista(GRAFO *gr, int vi, int vf) {
    ADJACENCIA *novo = criarAdj(vf);
...
int criarAresta(GRAFO *gr, int vi, int vf) {
    ...
    inserirNaLista(gr, vi, vf);
    inserirNaLista(gr, vf, vi); /* nao direcional */
    gr->aresta++;
    return 1;
}
